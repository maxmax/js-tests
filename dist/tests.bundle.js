...
/******/ 	var hotCurrentHash = "acd40302ba0b25549620"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(30), __webpack_require__(50)(module)))
...
var Animal = function () {
  function Animal() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Empty';
...
var _wrapper = __webpack_require__(219);
...
var _2 = __webpack_require__(220);

var _foo = __webpack_require__(236);

var _nums = __webpack_require__(237);

var _inj = __webpack_require__(238);

var _print = __webpack_require__(175);
...
var _maths = __webpack_require__(244);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//components
var resultColor = "background: green; color: white";
var errorColor = "background: red; color: white";
var successColor = "background: #28a745; color: white";

function testWrapper() {
  console.log('MountWrapper!');

  var impAmount = "Amount of imports: " + (_nums.one + _nums.two);
  console.log("%c impAmount:", successColor, impAmount);

  //questions views
  var questions = [{ title: '1. What is the value?', code: _2.square, result: (0, _2.square)(11) }, { title: '2. What is the value?', code: _2.resultValue, result: (0, _2.resultValue)() }, { title: '3. What is the value of result?', code: _2.counterThree, result: (0, _2.counterThree)() }, { title: '4. What is the output?', code: _2.isOutput, result: (0, _2.isOutput)() }, { title: '5. What is the output?', code: _2.whatOutput, result: (0, _2.whatOutput)() }, { title: '6. What is the value of a, b?', code: _2.whatValue, result: (0, _2.whatValue)(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']) }, { title: '7. What is the value of result?', code: _2.sevenValue, result: (0, _2.sevenValue)() }, { title: '8. What is the value of result?', code: _2.eightValue, result: (0, _2.eightValue)() }, { title: '9. What should the toString function be?  to print "I Amory Blaine am 102 years old."', code: _2.shouldToString, result: (0, _2.shouldToString)() }, { title: '10. What is the value of result? :', code: _2.whatIs, result: (0, _2.whatIs)() }, { title: '11. What is the output? :', code: _2.whatIsOutput, result: (0, _2.whatIsOutput)() }, { title: '12. What is the value of result?', code: _2.twelveResult, result: (0, _2.twelveResult)() }, { title: '13. What is the value of child.b after this piece of code is executed?', code: _2.whatExecuted, result: (0, _2.whatExecuted)() + " b3, c4" }, { title: '14. What is the output?', code: _2.fourteenOutput, result: (0, _2.fourteenOutput)() }, { title: '15. What is the output?', code: _2.fifteenOutput, result: (0, _2.fifteenOutput)() }, { title: '16. What is the output?', code: _2.sixteenOutput, result: (0, _2.sixteenOutput)() }, { title: '17. Complete the implementation of this method so that it returns the sum of its arguments. **', code: _2.sumArguments, result: (0, _2.sumArguments)(1, 2, 3, 4) }, { title: '17.2 sumArgumentsSecond. **', code: _2.sumArgumentsSecond, result: (0, _2.sumArgumentsSecond)(0, 1, 2, 3, 4) }, { title: '18. What is the value of result?', code: _2.eighteenth, result: (0, _2.eighteenth)() }, { title: '19. What is the value of result?', code: _2.nineteenth, result: (0, _2.nineteenth)() }, { title: '20. What is the output?', code: _2.twentieth, result: (0, _2.twentieth)() }, { title: '21. What is the value of results?', code: _2.twentyOne, result: (0, _2.twentyOne)() }, { title: '22. What is the output?', code: _2.twentyTwo, result: (0, _2.twentyTwo)() }, { title: '23. What is the output?', code: _2.twentyThree, result: (0, _2.twentyThree)() }, { title: '24. What is the output?', code: _2.twentyFour, result: (0, _2.twentyFour)() }, { title: '25. What is the output?', code: _2.twentyFive, result: (0, _2.twentyFive)() }, { title: '26. What is the value of pie?', code: _2.twentySix, result: (0, _2.twentySix)() }, { title: '27. What is the output?', code: _2.twentySeven, result: (0, _2.twentySeven)() }, { title: '28. What is the output?', code: _2.twentyEight, result: (0, _2.twentyEight)() }, { title: '29. What is the output?', code: _2.twentyNine, result: (0, _2.twentyNine)() }, { title: '30. What is the output?', code: _2.thirtyOutput, result: (0, _2.thirtyOutput)() }, { title: '31. What is the value of message?', code: _2.thirtyOne, result: (0, _2.thirtyOne)() }, { title: '32. What is the value of matches?', code: _2.thirtyTwo, result: (0, _2.thirtyTwo)() }, { title: '33. What is the output?', code: _2.thirtyThree, result: (0, _2.thirtyThree)() }, { title: '34. What is the output?', code: _2.thirtyFour, result: (0, _2.thirtyFour)() }, { title: '35. What is the output?', code: _2.thirtyFive, result: (0, _2.thirtyFive)() }, { title: '36. What is the result?', code: _2.promiseRes, result: (0, _2.promiseRes)() }, { title: '37. What is the result?', code: _2.intRes }, { title: '38. What is the result?', code: _2.numRes, result: (0, _2.numRes)() }, { title: '39. What is the result?', code: _2.reverseOutput, result: (0, _2.reverseOutput)() }];
  ...
  function component() {
    ...
    element.innerHTML = _.join(['<h1>JS base</h1>', (0, _foo.foo)(questions), footerOutput], ' ');
  ...
  (0, _2.intRes)();
  //results
  console.log("%c 13. What is the value of child.b after this piece of code is executed?", resultColor, (0, _2.whatExecuted)());
  console.log("%c 17. Complete the implementation of this method so that it returns the sum of its arguments. :", resultColor, (0, _2.sumArguments)(1, 2, 3, 4));
  console.log("%c 17.2 sumArgumentsSecond. :", resultColor, (0, _2.sumArgumentsSecond)(0, 1, 2, 3, 4));
  console.log("%c 20. What is the output? :", errorColor, (0, _2.twentieth)());
  console.log("%c 33. What is the output? :", errorColor, (0, _2.thirtyThree)());
  console.log("=====================//=====================");
  ...
  var store = (0, _redux.createStore)(counter, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
exports.counterThree = counterThree;
exports.isOutput = isOutput;
exports.whatOutput = whatOutput;
exports.whatValue = whatValue;
exports.sevenValue = sevenValue;
exports.eightValue = eightValue;
exports.shouldToString = shouldToString;
exports.whatIs = whatIs;
exports.whatIsOutput = whatIsOutput;
exports.twelveResult = twelveResult;
exports.whatExecuted = whatExecuted;
exports.fourteenOutput = fourteenOutput;
exports.fifteenOutput = fifteenOutput;
exports.sixteenOutput = sixteenOutput;
exports.sumArguments = sumArguments;
exports.sumArgumentsSecond = sumArgumentsSecond;
exports.eighteenth = eighteenth;
exports.nineteenth = nineteenth;
exports.twentieth = twentieth;
...
exports.thirtyOutput = thirtyOutput;
exports.thirtyOne = thirtyOne;
exports.thirtyTwo = thirtyTwo;
exports.thirtyThree = thirtyThree;
exports.thirtyFour = thirtyFour;
exports.thirtyFive = thirtyFive;
exports.promiseRes = promiseRes;
exports.intRes = intRes;
exports.numRes = numRes;
exports.reverseOutput = reverseOutput;

var _animal = __webpack_require__(174);

var _animal2 = _interopRequireDefault(_animal);

var _bar = __webpack_require__(235);
...
function counterValue() {
  var counter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
...
function isOutput() {
  return "isOutput:",  true ? "undefined" : (0, _typeof3.default)(undefined), "isOutput:", typeof NaN === "undefined" ? "undefined" : (0, _typeof3.default)(NaN);
}
...
function whatValue() {
  var daysOfWeek = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
function eightValue() {
  var empty_object = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var result = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

  if ((typeof empty_object === "undefined" ? "undefined" : (0, _typeof3.default)(empty_object)) === "object") {
    result = true;
  }
  return result;
}
...
function whatExecuted() {
  ...
  var child = (0, _create2.default)(father);
  child.a = 1;
  child.b = 2;
  delete child.b;
  return father;
...
function sixteenOutput() {
  ...
  var a = new A();
  var b = new B();
  return (0, _typeof3.default)(a.constructor), a.constructor.name, b.constructor.name;
}
...
function eighteenth() {
  var invokee = function invokee(message) {
    return this + " " + message;
  };
...
function nineteenth() {
  var invokee = function invokee(message1, message2) {
...
function twentyThree() {
  var x = [1, 2, 3, 4].map(function (x, y) {
    return x + y;
  });
  return x;
}
...
function twentySeven() {
  var outerVariable = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "error";
  var innerVariable = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "error";
...
function thirtyOutput() {
  ...
  (function (pv) {
    ...
    console.log("thirtyOutput pv:", typeof secretValue === "undefined" ? "undefined" : (0, _typeof3.default)(secretValue));
    console.log("thirtyOutput pv:", typeof publicValue === "undefined" ? "undefined" : (0, _typeof3.default)(publicValue));
  })(publicValue);
  return publicValue;
}
...
function thirtyFive() {
  var a = null;
  return (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a)) === "object";
}
...
function promiseRes() {
  ...
  promise.then(function (result) {
    return console.log("35. What is the output:", result);
  });
  //return result;
}
...
function intRes() {
  var intbar = document.querySelector('#output');
  var see = document.querySelector('[data-role="see"]');
  var mainbar = new _bar2.default('ololo', intbar, see);
  mainbar.speak();
}
...
var ctx = __webpack_require__(38);
var call = __webpack_require__(225);
    ...
    value: function speak() {
      ...
      if (this.ind) {
        this.ind.addEventListener('click', function () {
          var animal = new _animal2.default(inname);
...
function injFun() {
  var films = (0, _api.fetchInt)('https://ghibliapi.herokuapp.com/films/');
  var beers = (0, _api.fetchInt)('https://api.punkapi.com/v2/beers?page=1&per_page=20');
  _promise2.default.all([films, beers]).then(function (values) {
    var resfilms = (0, _table.tableFilms)(values[0]);
...
var fetchInt = exports.fetchInt = function fetchInt(url) {
  var res = fetch(url, myInit).then(status).then(json).then(function (data) {
    return data;

...
/******/ 	return hotCreateRequire(146)(__webpack_require__.s = 146);
/******/ })
/************************************************************************/
/******/ ({
...
var _conf = __webpack_require__(147);
...
var _videoplayback = __webpack_require__(156);

var _videoplayback2 = _interopRequireDefault(_videoplayback);
...
function App(options) {
  ...
  var view = options.elem;

  view.innerHTML = (0, _layout.layout)({ title: 'under water', url: _videoplayback2.default });

  var element = hotlayer();
  ...
  (0, _conf.devconf)(view.querySelector('#deviceSelect'));

  //Slide events
  var hrtwo = view.querySelector("#hr-two .caption");
  var hrthree = view.querySelector("#hr-three .caption");
  var hrselect = view.querySelector("[class*='selection'] .form-control");

  window.onscroll = function () {
    if ((0, _helpers.checkVisible)(hrtwo)) {
      view.className = "two";
    } else if ((0, _helpers.checkVisible)(hrthree)) {
      view.className = "three";
    } else if ((0, _helpers.checkVisible)(hrselect)) {
      view.className = "top";
    } else {
      view.className = "def";
    }
...
function selectDev(x) {
  ...
  var val = x.getElementsByTagName("option")[v].value;
  var device = view.querySelector('[data-targets="device-base"]');
  device.className = val;
}

function devconf(int) {
  var btn = int.querySelector('button');
  var x = int.querySelector('select');
...
var _slide = __webpack_require__(150);

var _device = __webpack_require__(151);

var _selection = __webpack_require__(153);
...
function layout(props) {
  ...
  var start = (0, _slide.Slide)('start', 'Started');
  var two = (0, _slide.Slide)('two', 'Two');
  var three = (0, _slide.Slide)('three', 'Three');
  var end = (0, _slide.Slide)('end', 'Fin');

  var result = "\n    <div class=\"landing\">\n      " + (0, _media.Media)(url) + "\n      " + (0, _selection.Selection)('New device:') + "\n      " + (0, _device.Device)('base') + "\n      <div class=\"slides\">\n        " + start + "\n        " + two + "\n        " + three + "\n        " + end + "\n      </div>\n    </div>\n  ";
  return result;
}
...
var Slide = exports.Slide = function Slide() {
  var slide = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return '<section class=\'' + ("slide-" + slide) + '\' id=\'' + ("hr-" + slide) + '\'>\n    <section class=\'caption\' data-title=\'' + title + '\'></section>\n  </section>';
};
...
var _control = __webpack_require__(152);

var Device = exports.Device = function Device() {
  var device = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'default';
  return "<section data-targets='" + ("device-" + device) + "' id='deviceInt'>\n    <div class=\"top\"></div>\n    <div class=\"air\"></div>\n    <div class=\"bot\"></div>\n    " + (0, _control.Control)('new device control') + "\n  </section>";
};
...
var Control = exports.Control = function Control() {
  var control = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'default';
  return "<div class='" + ("control-" + control) + "'>" + control + "</div>";
};
...
module.exports = __webpack_require__.p + "f1cd6d2ca651c6515c27661098f0339e.mp4";
